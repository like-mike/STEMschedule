...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:stemscheduleConnectionString %>" SelectCommand="SELECT * FROM [UserData]" ProviderName="<%$ ConnectionStrings:stemscheduleConnectionString.ProviderName %>"></asp:SqlDataSource>
